    ...
    <div className=" px-6 py-8 bg-primary max-w-4xl">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 ">
              Your Gemini API keys are securely hashed using bcrypt before being
      ...
      <div className="mb-6 bg-primary">
        <Dialog open={showNewKeyDialog} onOpenChange={setShowNewKeyDialog}>
          <DialogTrigger asChild className="bg-black/70 ">
            <Button className="flex items-center text-white gap-2 cursor-pointer">
              <Plus className="w-4 h-4" />
              Add your Gemini API Key
            </Button>
          </DialogTrigger>
          <DialogContent className="bg-black/70 border-1 border-white/40 rounded-2xl">
            <DialogHeader>
